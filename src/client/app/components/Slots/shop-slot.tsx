...
import { PlayerQuirkymals } from "shared/store/players/players-slice/types";
import { PlayerSkins } from "shared/store/players/players-slice/types";

export interface ShopSlotProperties extends React.PropsWithChildren {
	IsActive?: boolean;
	IsSkin?: boolean;
	LayoutOrder?: number;
	Price: number;
	Quirkymal: keyof typeof QuirkymalIcons;
	Rarity: keyof typeof Images.Shop.Slots;
...
export default function ShopSlot(properties: ShopSlotProperties): React.Element {
	...
	return (
		...
		>
			...
			<AnimatedImageButton
				...
				Image={Images.Shop.Slots[properties.Rarity]}
			...
			>
				<textlabel
					...
					Size={new UDim2(0.5670000000000001, 0, 0.127, 0)}
